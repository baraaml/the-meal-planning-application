...
SELECT ri2.content_id, ri2.content_type,
...
LEFT JOIN "Post" p ON ri2.content_id = p.id AND ri2.content_type = 'post'
LEFT JOIN "Community" c ON ri2.content_id = c.id AND ri2.content_type = 'community'
WHERE ri2.content_id != :content_id
{type_filter}
GROUP BY ri2.content_id, ri2.content_type, p.title, c.name
